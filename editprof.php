...
$sql="select * from profile WHERE userid='".$_SESSION['iduser']."'";
...
{
	$sql="insert into profile (userid,city,state,pincode,country,hschool,coluni,course) values( '".$_SESSION['iduser']."','".$_POST['city']."','".$_POST['state']."','".$_POST['pincode']."','".$_POST['loc']."','".$_POST['hschool']."','".$_POST['coll']."','".$_POST['hschool2']."')";
