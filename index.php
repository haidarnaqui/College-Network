...
<tr>
	<td width="70%">
		<img src="images/answers.jpg" width="518" height="137" border="0" alt="">
		...
		<h2>About Us</h2>		
		The College networking website is an online community designed to make your Campus life more active and stimulating. The College network can help you maintain existing relationships with college students and share pictures and messages, and establish new ones by reaching out to people you've never met before, and also using this site user can share Knowledge's, education related books, question/answer, etc. </td>
	<td width="30%" valign="top"><img src="images/imaa.png" width="70%" height="199"><br>
	<h2>Registration</h2>
...
<form id="registration" name="registration" method="post" action="index.php" onSubmit="return reg()">
			<tr>
			  ...
			  <td width="91"><input name="fname" type="text" id="fname" value="" size="18"></td>
			  </tr>
			<tr>
			  <td>Last Name</td>
			  <td><input name="lname" type="text" id="lname" value="" size="18"></td>
			  </tr>
			<tr>
			  <td>Email</td>
			...
			<tr>
			  <td>Confirm</td>
			  <td><input name="cpass" type="Password" id="cpass" size="18"></td>
			  </tr>
			<tr>
			  <td>I am</td>
			  <td><label>
