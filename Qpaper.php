...
<table width="958" height="372">
  ...
  <tr>
    ...
    <td><select name="select" id="select">
                 <option id="">--select section--</option>
  ...
  <tr>
    ...
    <td><select name="select2" id="select2">
	  <option id="">--select subject--</option>
	<option id="1">DSA</option>
	<option id="2">OS</option>
	<option id="1">NETWORKING</option>
	<option id="1">COA</option>
    </select></td>
  </tr>
  <tr>
